...
<c:if test="${lang == 'in' }"><link href="/css/ina.css" rel="stylesheet" type="text/css" /></c:if>
...
<script type="text/javascript" src="<c:url value="/js/jquery.inputmask.bundle.js"/>"></script>
