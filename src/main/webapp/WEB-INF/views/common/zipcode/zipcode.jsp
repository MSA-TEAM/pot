	...
	<div class="modal-content pop-wrap">
		...
		<div class="modal-body find-address-wrap">
			<ul class="tab-type3">
				...
				<li id="type_ad_<%=modal%>"><a href="#zipcodeTab2" onClick="showTab(this, 'pop-tab-con');cleanElement_<%=modal%>();return false;"><spring:message code="cfs.header.address"/> </a></li>
				<li id="type_bd_<%=modal%>"><a href="#zipcodeTab3" onClick="showTab(this, 'pop-tab-con');cleanElement_<%=modal%>();return false;"><spring:message code="cfs.header.bldg_address"/></a></li>
			</ul>
<!-- 			도로명 주소 -->
	        ...
	        <div id="zipcodeTab2" class="pop-tab-con" style="display:none;">
				...
				<div class="table-wrap">
					<div class="table-form">
						...
						<div class="row">
	                        <div class="cell-title"> <label for="tab2_dong_nm_<%=modal%>"><spring:message code="cfs.header.dong"/></label> </div>
	                        <div class="cell-content">
	                            <input class="inptB full" type="text" name="tab2_dong_nm_<%=modal%>" id="tab2_dong_nm_<%=modal%>" value="" placeholder="예) 저동2가" title="읍/면/동 입력">
	                        </div>
						</div>
						<div class="row">
	                        <div class="cell-title"> <label for="tab2_addr_no_<%=modal%>"><spring:message code="cfs.header.bunji"/></label> </div>
	                        <div class="cell-content">
			...
			<div id="zipcodeTab3" class="pop-tab-con" style="display:none;">
				...
				<div class="table-wrap">
					<div class="table-form">
						...
						<div class="row">
							<div class="cell-title"> <label for="tab3_bldg_nm_<%=modal%>"><spring:message code='cfs.header.bldg_nm'/> </label> </div>
							<div class="cell-content">
...
//<![CDATA[
	...
	function searchAddress_<%=modal%>(type){
		...
		if('st' == type){
			...
			url = '/cfs/addrsrch/data/addrlist';
			...
			url = '/cfs/addrsrch/data/bldglist';
