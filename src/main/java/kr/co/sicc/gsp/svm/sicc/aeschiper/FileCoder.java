package kr.co.sicc.gsp.svm.sicc.aeschiper;
...
//	private static final Base64 ENCODER_64 = new Base64();
//	private static final Base64 DECODER_64 = new Base64();
	...
	public static String decrypt(final String msg) throws IOException,
		...
		byte[] encrypt =Base64.decodeBase64(msg);
